...
-- Note: The original generic users table might conflict with the specific one. 
-- Merging assumption: `public.users` is the main one. I combined `public.public.users` attributes if missing.
-- Re-adding columns from visual check if needed.
...
-- Apply Migration: Add payout_percent
